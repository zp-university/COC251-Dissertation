...
%Maybe use this? Unsure...
\unsure{Should this be included? If so expand, otherwise delete.}
\info{not needed - you'll talk about this in lit review/background}

\section{Relevance to Degree}
%Also might be worth having this section, again, unsure}
\unsure{Should this be included? If so fill out, otherwise delete.}
\info{not needed}
